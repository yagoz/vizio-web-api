...
$sc->register('listener.exception', HttpKernel\EventListener\ExceptionListener::class)
    ->setArguments(array('Error\Controller\ErrorController::exceptionAction'))
;
...
$sc->register('listener.responselistener', ResponseListener::class);
